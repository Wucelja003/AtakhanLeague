...
export default function GlitterWarp({
  ...
  useEffect(() => {
    ...
    // Honour reduced-motion: draw a single static frame instead of animating.
    ...
    // WebGL may be unavailable (old driver / blocked). Fail soft: no canvas,
    // the page background still shows and the form works normally.
    ...
    // Pause the loop while the tab is hidden — no wasted GPU in the background.
    const handleVisibility = () => {
      isPausedRef.current = document.hidden ? true : !autoPlay;
    };
