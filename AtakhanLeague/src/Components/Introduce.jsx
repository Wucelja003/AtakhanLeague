export default function Introduce() {
  return (
    <section className="relative z-[2] mt-[80px] sm:mt-[100px] px-5 py-16 sm:py-20">
      <div className="mx-auto flex flex-col lg:flex-row items-center max-w-6xl gap-10 lg:gap-[60px]">
        <div className="flex-1 border-l-[3px] border-[#660000] pl-5 sm:pl-7 animate-slide-in-left">
        ...
        {/* Demon image — hidden on mobile, visible on desktop */}
        <img
          src="/mainDemon-removebg-preview.png"
          alt="Atakhan Demon"
          className="hidden lg:block flex-1 w-full max-w-[480px] animate-slide-in-right"
        />
      </div>
