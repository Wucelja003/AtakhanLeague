    ...
    <section className="relative z-[2] mt-[100px] px-5 py-4">
      <div>
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-3 font-heading text-[60px] leading-none tracking-[2px] text-transparent bg-clip-text bg-[linear-gradient(90deg,#660000,#DC143C,#660000)] [filter:drop-shadow(0_0_18px_rgba(139,0,0,0.5))]">
            August 15
          </h2>
